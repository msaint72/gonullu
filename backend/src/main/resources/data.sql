...
insert into users(id,first_name, last_name, profile_image, mobile_phone, e_mail, date_of_birth, t_shirt_size, gender, emergency_contact_number, emergency_contact_name, motivation,
    affiliation,school_name, company_name, get_info_mails, invisible) values
    (40001,'Mahmut','Eren',null,'+905332394700','mahmut.eren72@gmail.com','1972-06-29','M','E','+905332394799','Hayati Çalık','abele gübele',true,null,'Gönüllü.Com',true,true);
